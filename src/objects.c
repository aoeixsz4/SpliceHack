...
SPELL("psi bolt",        "moth-eaten",
      P_ATTACK_SPELL,       0,  10, 3, 1, IMMEDIATE, CLR_YELLOW),
SPELL("stun",            "spectral",
      P_ENCHANTMENT_SPELL,  0,  10, 3, 1, IMMEDIATE, CLR_BLUE),
SPELL("drain strength",  "throbbing",
      P_ENCHANTMENT_SPELL,  0,  10, 5, 1, IMMEDIATE, CLR_RED),
SPELL("curse items",     "iron-bound",
      P_MATTER_SPELL,       0,  10, 5, 1, IMMEDIATE, CLR_GRAY),
SPELL("destroy armor",   "loose-leaf",
      P_MATTER_SPELL,       0,  10, 5, 1, IMMEDIATE, CLR_WHITE),
SPELL("aggravation",     "insidious",
      P_ENCHANTMENT_SPELL,  0,  10, 6, 1, NODIR, CLR_BLACK),
SPELL("summon nasties",  "felt",
      P_MATTER_SPELL,       0,  10, 6, 1, NODIR, CLR_GREEN),
SPELL("double trouble",  "backwards",
...
SPELL("insect swarm",    "wormwood",
      P_CLERIC_SPELL,       0,  10, 6, 1, NODIR, CLR_BROWN),
SPELL("flame pillar",    "obsidian",
      P_CLERIC_SPELL,       0,  10, 4, 1, NODIR, CLR_ORANGE),
SPELL("geyser",          "soggy",
      P_CLERIC_SPELL,       0,  10, 6, 1, NODIR, CLR_CYAN),
