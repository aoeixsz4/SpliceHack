...
NEARDATA struct permonst mons[] = {
    ...
    MON("caterwaul", S_FELINE, LVL(6, 24, 4, 0, 0), (G_NOHELL | G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
          ATTK(AT_BITE, AD_PHYS, 1, 4), ATTK(AT_SCRE, AD_LOUD, 2, 4), 
          NO_ATTK, NO_ATTK),
        SIZ(300, 100, MS_GROWL, MZ_HUMAN), 0, 0,
        M1_ANIMAL | M1_HUMANOID | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, 
        M3_INFRAVISIBLE, 0, 10, CLR_GRAY),
    ...
    MON("sabre-toothed cat", S_FELINE, 
        ...
        M3_INFRAVISIBLE, 0, 13, CLR_YELLOW),
