...
struct permonst _mons2[] = {
    ...
    MON("mad aligned priest", S_HUMAN, LVL(12, 12, 10, 50, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_KICK, AD_PHYS, 1, 4),
          ATTK(AT_MAGC, AD_CLRC, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_PRIEST, MZ_HUMAN), MR_FIRE, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_LORD | M2_PEACEFUL | M2_COLLECT,
        M3_INFRAVISIBLE, MH_HUMAN, 15, CLR_WHITE),
    MON("penitent aligned priest", S_HUMAN, LVL(12, 12, 10, 50, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_KICK, AD_PHYS, 1, 4),
          ATTK(AT_MAGC, AD_CLRC, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_PRIEST, MZ_HUMAN), MR_COLD, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_LORD | M2_PEACEFUL | M2_COLLECT,
        M3_INFRAVISIBLE, MH_HUMAN, 15, CLR_WHITE),
